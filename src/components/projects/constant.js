export const projects = [
    {
        ...
        text_sections: [
            {
                title: 'Abstract',
                body: 'The modern world is inundated with tasks, events, and responsibilities, making it challenging for individuals to keep track of their daily activities and habits. This case study delves into the development of an organizer application that leverages artificial intelligence (AI) to identify and analyze user habits, providing a more personalized and efficient organizational experience.'
            },
            {
                title: 'Problem',
                body: 'With the proliferation of tasks in daily life, many individuals struggle to maintain a structured routine. Traditional organizer applications offer static features that require manual input, often leading to inconsistent usage and a lack of personalization. Furthermore, these applications fail to provide insights into the user\'s habits, making it difficult for users to identify areas of improvement in their daily routines.'
            },
            {
                title: 'Solution',
                body: 'To address these challenges, we developed an organizer application that integrates AI capabilities. The application automatically tracks user activities and employs machine learning algorithms to identify recurring habits. By recognizing these patterns, the application offers personalized suggestions, reminders, and insights, enabling users to optimize their daily routines and achieve their goals more efficiently.'
            },
            {
